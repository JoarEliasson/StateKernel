...
/// <summary>
/// Represents the minimal deterministic context required by baseline transition conditions.
/// </summary>
/// <remarks>
...
/// deterministic transition condition requires additional state.
/// </remarks>
public sealed class SimulationStateTransitionConditionContext
{
    /// <summary>
    /// Initializes a new instance of the <see cref="SimulationStateTransitionConditionContext" /> type.
    /// </summary>
    ...
    /// </exception>
    public SimulationStateTransitionConditionContext(
